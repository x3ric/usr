 ...
 ***/
 ...
 //user_pref("javascript.options.ion", true); //javascript "hardening", might cause slowdowns/breakage
 //user_pref("javascript.options.asmjs", true); //same as above
 //user_pref("javascript.options.wasm", true); //WebAssembly support. Completly disables WASM, for the security gain and speed loss
 //user_pref("javascript.options.baselinejit", true); //Disabled Just In Time compilation - usually breaks sites with a lot of javascript but is a huge security gain
 ...
 // history arkanfox renable history
 ...
 user_pref("widget.gtk.libadwaita-colors.enabled", true);
 user_pref("extensions.webextensions.restrictedDomains.enabled", false);

 /*
   DISCLAIMER: This user.js file has been edited based on the Arkenfox user.js
   to adjust preferences for a softer configuration. While efforts have been made
   to maintain privacy and security, it's essential to recognize that this version
   may not incorporate the same level of hardening as the original Arkenfox version.
   Users should exercise caution and review their settings carefully to ensure they
   align with their privacy and security requirements. Remember, you can tweak
   this file to better suit your needs.
 */
