...
local function default_style()
	...
	return utils.table.merge(style, utils.table.check(beautiful, "desktop.common.pack.lines") or {})
end
...
function barpack.new(num, style)
	...
	local progressbar_style = utils.table.merge(style.progressbar, { color = style.color })
	local label_style = utils.table.merge(style.label, { color = style.color.gray })
	local text_style = utils.table.merge(style.text, { color = style.color.gray })
