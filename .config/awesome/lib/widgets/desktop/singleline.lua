...
local textbox = require("lib.widgets.desktop.common.textbox")
...
local function default_style()
	...
	return utils.table.merge(style, utils.table.check(beautiful, "desktop.singleline") or {})
end
...
function sline.new(args, style)
	...
	local function set_raw_state(state, crit, i)
		...
		local txt = utils.text.dformat(state[2] or state[1], style.unit, style.digits)
