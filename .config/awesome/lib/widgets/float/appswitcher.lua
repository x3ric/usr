...
local dfparser = redutil.service.dfparser
...
appswitcher.keys.move = {
	{
		{ "Mod4" }, "Right", function() appswitcher:switch() end,
		{ description = "Select next app", group = "Navigation" }
	},
	{
		{ "Mod4" }, "Left", function() appswitcher:switch({ reverse = true }) end,
