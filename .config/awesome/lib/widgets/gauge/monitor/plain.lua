...
local function default_style()
	...
	return utils.table.merge(style, utils.table.check(beautiful, "gauge.monitor.plain") or {})
end
...
function monitor.new(style)
	...
	function widg:draw(_, cr, width)
		...
		utils.cairo.textcentre.horizontal(cr, { width/2, style.text_shift }, self._data.label)
