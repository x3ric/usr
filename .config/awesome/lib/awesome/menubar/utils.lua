...
local function get_icon_lookup_path()
    ...
    icon_lookup_path = {}
    local theme_priority = { 'hicolor' , 'Adwaita' }
    ...
    for _, icon_theme_directory in ipairs(icon_theme_paths) do
        for _, size in ipairs(all_icon_sizes) do
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'actions' }))
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'apps' }))
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'places' }))
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'categories' }))
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'mimetypes' })) 
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'panel' })) 
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'status' })) 
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'emotes' }))         
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'emblems' }))         
            table.insert(app_in_theme_paths,glib.build_filenamev({ icon_theme_directory,size, 'devices' }))   
        end
    end
